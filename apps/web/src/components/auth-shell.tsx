    ...
    <main className="pb-app-bg relative grid min-h-dvh place-items-center overflow-hidden px-4 py-10">
      ...
      >
        ...
        <Link href="/" className="mb-8 flex items-center justify-center gap-3">
          <span className="grid h-11 w-11 -skew-x-6 place-items-center rounded-xl border border-primary-orange/60 bg-primary-orange font-display text-white shadow-[0_0_24px_color-mix(in_srgb,var(--primary-orange)_36%,transparent)]">
            PB
          </span>
          <span className="font-display text-2xl uppercase tracking-wider">PickBros</span>
        </Link>
